...
export default function HeroSection() {
  ...
  return (
    <section className="flex flex-col items-center justify-start sm:justify-center flex-1 px-4 sm:px-6 md:px-8 text-center pt-16 sm:pt-28 md:pt-[145px] pb-10 sm:pb-16 relative z-10 max-w-5xl mx-auto w-full">
